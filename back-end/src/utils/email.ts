    ...
    <style>
      ...
      @media all {
        ...
        .btn-primary table td:hover {
          background-color: #cc4303 !important; 
        }
        .btn-primary a:hover {
          background-color: #af2a02 !important;
          border-color: #af2a02 !important; 
        } 
      }
              ...
              <tr>
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>${name ? `Hi, ${name}!` : `Hi, Anonim!`}</p>
                        <p>You received a transfer to your Push wallet.</p>
                        <p>Follow the link to receive funds${
