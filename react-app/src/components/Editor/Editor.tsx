...
import { Button, Collapse, Input, message, Select, Switch, Upload } from 'antd';
...
//   const store = useContext(AppStoreContext);
  ...
  useEffect(() => {}, [pStore.currentPresetString]);

  const savePreset = async () => {
    try {
      console.log(pStore.currentPreset);
      await setCampaignPreset(
        mStore.link!,
        mStore.password!,
