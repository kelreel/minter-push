...
const YandexEda: React.FC<{ visible: boolean }> = observer(({ visible }) => {
  ...
  return (
    <Modal
      destroyOnClose={true}
      wrapClassName="yandex-eda"
      maskClosable={false}
      visible={state.visible}
      title={t("yandexEda.title")}
      onOk={handleOk}
      ...
      {store.balance && (
        <>
          <Alert
            ...
            type="warning"
            message={t("yandexEda.content1")}
          ></Alert>
          <div className="send-form">
            <div className="field">
              <label>{t("yandexEda.select")}</label>
              <Select
